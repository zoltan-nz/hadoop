...
public class TaskThree extends Configured implements Tool {
	private static final String NUMBER_OF_SEARCH_JOB_NAME = "task3-searches";
	private static final String NUMBER_OF_USERS_JOB_NAME = "task3-users";
	private static final String NUMBER_OF_CLICKS_JOB_NAME = "task3-clicks";
	...
	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new Configuration(), new TaskThree(), args));
	}
	...
	private static void validateParams(String[] args) {
		...
		if (numberOfParams < 2) {
			throw new IllegalArgumentException("TaskThree expects 2 or 3 params: inputFile outputFile reduceTaskNumber(optional)");
		}
	}
